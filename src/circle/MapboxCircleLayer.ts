...
export type MapboxActualCircle = PolygonFeature & { id?: string | number };
        ...
        map.addLayer(
          {
            ...
            layout: {
              'fill-sort-key': ['get', MapboxCircleLayer.Prop.Z_INDEX],
            },
            paint: {
              'fill-color': ['get', MapboxCircleLayer.Prop.FILL_COLOR],
            },
        ...
        map.addLayer(
          {
            ...
            layout: {
              'line-cap': 'round',
              'line-join': 'round',
              'line-sort-key': ['get', MapboxCircleLayer.Prop.Z_INDEX],
            },
            paint: {
              'line-color': ['get', MapboxCircleLayer.Prop.STROKE_COLOR],
              'line-width': ['get', MapboxCircleLayer.Prop.STROKE_WIDTH],
            },
          } as LayerSpecification,
          beforeId,
        );
