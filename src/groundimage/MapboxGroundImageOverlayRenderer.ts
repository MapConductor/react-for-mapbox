import type { ImageSource, LayerSpecification, SourceSpecification } from 'mapbox-gl';
import {
...
export class MapboxGroundImageOverlayRenderer extends AbstractGroundImageOverlayRenderer<
  MapboxMapViewHolder,
  string
> {
