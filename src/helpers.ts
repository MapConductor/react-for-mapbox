...
export function removeLayerIfExists(map: MapboxMap, layerId: string): void {
  if (map.getLayer(layerId)) map.removeLayer(layerId);
}

export function removeSourceIfExists(map: MapboxMap, sourceId: string): void {
  if (map.getSource(sourceId)) map.removeSource(sourceId);
}

export function bringMarkerLayersToFront(map: MapboxMap): void {
