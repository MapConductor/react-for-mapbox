...
export class MapboxMarkerEventController {
  ...
  constructor(private readonly controller: MapboxMarkerController) {
  ...
  resync(): void {
    // Marker clicks are handled at the view level (MapboxViewController map.on('click')).
  }
