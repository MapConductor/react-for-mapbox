        ...
        map.addLayer(
          {
            ...
            layout: {
              'fill-sort-key': ['get', MapboxPolygonLayer.Prop.Z_INDEX],
            },
            paint: {
              'fill-color': ['get', MapboxPolygonLayer.Prop.FILL_COLOR],
            },
        ...
        map.addLayer(
          {
            ...
            layout: {
              'line-cap': 'round',
              'line-join': 'round',
              'line-sort-key': ['get', MapboxPolygonLayer.Prop.Z_INDEX],
            },
            paint: {
              'line-color': ['get', MapboxPolygonLayer.Prop.STROKE_COLOR],
              'line-width': ['get', MapboxPolygonLayer.Prop.STROKE_WIDTH],
            },
          } as LayerSpecification,
          beforeId,
        );
