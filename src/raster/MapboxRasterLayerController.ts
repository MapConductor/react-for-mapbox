...
import { MapboxRasterLayerOverlayRenderer } from './MapboxRasterLayerOverlayRenderer';

export class MapboxRasterLayerController {
  private readonly rasterLayerStates = new Map<string, RasterLayerState>();
  private readonly renderer: MapboxRasterLayerOverlayRenderer;
