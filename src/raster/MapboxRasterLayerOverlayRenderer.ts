...
export interface MapboxRasterLayerHandle {
 ...
 * で貼り直す。
 */
export class MapboxRasterLayerOverlayRenderer
  implements RasterLayerOverlayRenderer<MapboxRasterLayerHandle>
{
  constructor(
  ...
  async onAdd(data: RasterLayerAddParams[]): Promise<(MapboxRasterLayerHandle | null)[]> {
  ...
  async onChange(
    data: RasterLayerChangeParams<MapboxRasterLayerHandle>[],
  ): Promise<(MapboxRasterLayerHandle | null)[]> {
    this.flushPendingRemovals();
  ...
  async onRemove(data: RasterLayerEntity<MapboxRasterLayerHandle>[]): Promise<void> {
    this.flushPendingRemovals();
  ...
  private addLayer(state: RasterLayerState): MapboxRasterLayerHandle {
    const handle: MapboxRasterLayerHandle = {
  ...
  private updateLayer(handle: MapboxRasterLayerHandle, state: RasterLayerState): void {
   ...
   */
  private pendingRemovals: MapboxRasterLayerHandle[] = [];
  ...
  private removeLayer(handle: MapboxRasterLayerHandle): void {
